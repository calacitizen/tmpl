...
"__root"                           parser.restricted = false; return "ROOT";
...
DecoratorCalls
    ...
    | "(" CallExpressionNoBF DecoratorChain ")"
        {
            $$ = new DecoratorCallNode($3, $2);
        }
    | "(" CallExpressionNoBF ")" DecoratorChain
        {
            $$ = new DecoratorCallNode($4, $2);
        }
    | DecoratorChain
        {
            $$ = new DecoratorCallNode($1);
        }
    ;
...
DecoratorChain
    : DecoratorChainEntity
        {
            $$ = new DecoratorChainContext($1);
        }
    | DecoratorChain DecoratorChainEntity
        {
            $$ = new DecoratorChainContext($2, $1);
        }
    ;
...
DecoratorChainEntity
    : "|" "IDENTIFIER"
        {
            $$ = new DecoratorChainCallNode($2);
        }
    | "|" "IDENTIFIER" ":" ArgumentList
        {
            $$ = new DecoratorChainCallNode($2, $4)
        }
    | "|" "IDENTIFIER" ":" ArgumentList
        {
            $$ = new DecoratorChainCallNode($1, $3)
        }
    ;
...
ConditionalExpressionCast
    ...
    | LogicalORExpression "?" AssignmentExpression
        {
            $$ = new ConditionalExpressionNode($1, $3);
        }
    ;
