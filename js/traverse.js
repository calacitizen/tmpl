define('traverse', ['htmlparser', 'utils', 'skipVars', 'State', 'module', 'entityHelpers', 'include', 'template', 'partial'], function traverseLoader(htmlparser, utils, skipVars, State, moduleC, entityHelpers, inc, tmp, par) {
   var traverse = {
      _modules: {
         'ws:include': inc,
         'ws:template': tmp,
